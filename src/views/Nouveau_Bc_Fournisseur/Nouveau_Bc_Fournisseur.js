...
class Nouveau_Bc_Fournisseur extends Component {
  ...
  */
  ...
  getOrderByProviderId(id) {
    ...
    axios.get('http://localhost:4000/api/showBcClientByFrsId', {
      params: {
  ...
  */
  ...
  createNewBcProvider() {
    ...
    if (this.state.new_bc_Provider.length != 0) {
      axios.post('http://localhost:4000/api/addBcFrs', {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> {t("Nouveau_Bc_Fournisseur.title")}
              </CardHeader>
              <CardBody>
                <Alert color="danger" toggle={this.onDismiss} isOpen={this.state.alertBoxVisible}>
                  {t("Nouveau_Bc_Fournisseur.please_select")}
                </Alert>
                <Row>
                  <Label sm="2">
                  ...
                  <Col xs="4">
                    <Input type="select" name="id_provider" onChange={this.handleChange} id="select">
                      <option value="none">
                        {t("Nouveau_Bc_Fournisseur.select_provider")}
                      </option>
                ...
                <Row>
                  <h2> {t("Nouveau_Bc_Fournisseur.new_table_title")} : </h2>
                  <Table responsive striped>
                    <thead>
                      <tr>
                        <th>{t("tables_info.id_client")}</th>
                ...
                <Button color="success" onClick={this.createNewBcProvider}> {t("Nouveau_Bc_Fournisseur.button")} </Button>
              </CardBody>
            </Card>
          </Col>
        </Row>
...
const Nouveau_Bc_Fournisseur_Translated = withTranslation('common')(Nouveau_Bc_Fournisseur)


export default Nouveau_Bc_Fournisseur_Translated;
